...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class SupportLibraryAccessors extends SubDependencyFactory {
        private final SupportVectorLibraryAccessors laccForSupportVectorLibraryAccessors = new SupportVectorLibraryAccessors(owner);

        public SupportLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>support.vector</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public SupportVectorLibraryAccessors getVector() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForSupportVectorLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class SupportVectorLibraryAccessors extends SubDependencyFactory {

        public SupportVectorLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>drawable</b> with <b>com.android.support:support-vector-drawable</b> coordinates and
         * with version reference <b>supportVectorDrawable</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getDrawable() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("support.vector.drawable");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>supportVectorDrawable</b> with value <b>28.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSupportVectorDrawable() { return getVersion("supportVectorDrawable"); }
